        ...
        {projects.items.map((project, index) => {
          ...
          return (
            <div
              ...
              className={`group rounded-xl overflow-hidden bg-secondary hover:bg-secondary/80 transition-all duration-300 shadow-lg hover:shadow-2xl border border-transparent hover:border-accent/20 flex flex-col h-full animate-fade-in-up ${targetUrl ? 'cursor-pointer' : ''}`}
